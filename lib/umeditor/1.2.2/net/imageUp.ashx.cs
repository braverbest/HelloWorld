...
public class imageUp : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //上传图片
        Hashtable info;
        UploaderEdit up = new UploaderEdit();

        info = up.upFile(context, pathbase, filetype, size); //获取上传状态

        //string fileUploadPath = ConfigSettingHelper.GetAppStr("ImageUploaderFolderPath");
        //string path = ImageUploadHelper.UploadImage(up.uploadFile.FileName, up.uploadFile.InputStream, fileUploadPath);
        string path = "/";//删除
